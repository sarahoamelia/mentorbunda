...
<div class="navbar" role="navigation">
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            <li class="selected"><a href="{{url('/tes')}}">Beranda</a></li>
            <li><a href="{{url('/tes/tentang')}}">Tentang</a></li>
            <li><a href="{{url('/tes/galeri')}}">Galeri</a></li>
            <li><a href="{{url('/tes/artikel')}}">Artikel</a></li>
            <li class= "hidden-xs hidden-sm">
                <a rel="home" href="{{url('/home')}}"><img class="logo" src="{{asset('frontend/img/log.png')}}" width="200" alt="logo"></a>
            </li>
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="{{asset('frontend/img/slide3.jpg')}}" alt="">
            <div class="carousel-caption">

            </div>
        </div>
        <div class="item">
            <img src="{{asset('frontend/img/slide2a.jpg')}}" alt="">
            <div class="carousel-caption">

            </div>
        </div>
        <div class="item">
            <img src="{{asset('frontend/img/slide1a.jpg')}}" alt="">
            <div class="carousel-caption">
