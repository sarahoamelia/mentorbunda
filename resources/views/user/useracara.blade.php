...
<div class="navbar" role="navigation">
    ...
    <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
            ...
            <li class="selected"><a href="{{url('/tes/acara')}}">Acara</a></li>
        ...
        <div class="team-members inner-details">
            ...
            <div class="col-xs-4 member animated" data-animation="fadeInUp" data-animation-delay="0">
                <div class="member-inner">
                    ...
                    <a class="team-image">
                        <!-- Img -->
                        <img src="{{asset('frontend/event/event1.jpg')}}" alt="" />
                    </a>
                    <div class="member-details">
                        <div class="member-details-inner">
                            <!-- Name -->
                            <h5 class="member-name light">Pameran Ibu dan Anak Kids Mega Fair 2015</h5>
                            <!-- Description -->
                            <p class="member-description text-center">Tanggal : 25 – 27 Oktober 2013<br />
                                Tempat : Istora Senayan, Jakarta -
                                Rangkaian acara yang akan berlangsung di Kids Mega Fair 2013 nanti adalah: <br />
                                Mega EDU, Mega HEALTH <br />
                                Mega FAMILY, Mega BABY<br />
                                Dan juga akan diadakanprogram edukasi serta workshop & trial classes untuk ibu dan anak.<br />
                                Info dan kontak : Telp. : (021) 7135 2056 - Twitter : @KidsMegaFair
                                *didukung oleh JadwalEvent.Web.Id<br />
                            </p>
            ...
            <div class="col-xs-4 member animated" data-animation="fadeInUp" data-animation-delay="500">
                <div class="member-inner">
                    ...
                    <a class="team-image">
                        <!-- Img -->
                        <img src="{{asset('frontend/event/event2.jpg')}}" alt="" />
                    </a>
                    <div class="member-details">
                        <div class="member-details-inner">
                            <!-- Name -->
